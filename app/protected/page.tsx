    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          {/* WhatsApp Section */}
          <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 transition-all hover:shadow-lg">
            <div className="flex items-center justify-center mb-4">
            ...
            <p className="mb-6 text-gray-600 dark:text-gray-300">
              Rejoignez le groupe WhatsApp inter-promotion pour rester connecté
              avec les membres de toutes les années :
            </p>
            <a
